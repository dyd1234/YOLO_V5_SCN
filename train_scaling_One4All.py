...
# pair up the 
import val_scaling_One4All as validate_scale  # for end-of-epoch mAP
...
from utils.augmentations import ( # pre-defined data_argumentation
    ...
    fixed_perspective_batch_v3, # for only scaling 
)
        ...
        for f in last, best:
            if f.exists():
                ...
                if f is best:
                    ...
                    # 这个东西还是要好好思考一下怎么保存结果
                    results, _, _ = validate_scale.run_final_test( # run_final_test # 
                        data_dict,
                        batch_size=batch_size // WORLD_SIZE * 2,
                        imgsz=imgsz,
