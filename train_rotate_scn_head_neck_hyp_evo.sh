...
# python train_rotate_scn.py --data stanford_dogs_new.yaml --epochs 500 --weights '' --cfg yolov5s_scn_neck_head_d8.yaml --hyp data/hyps/hyp.scratch-hyp-evolution.yaml --batch-size 128 --device 0 --cache ram --seed 50 --project YOLOv5_Rotate_scn_neck_head_test_d8_hyp_evo --workers 20 --imgsz 320 --optimizer Adam
...
# try with the loss for the beta2
# python train_rotate_scn.py --data stanford_dogs_new.yaml --epochs 500 --weights '' --cfg yolov5s_scn_neck_head_d8.yaml --hyp data/hyps/hyp.scratch-hyp-evolution.yaml --batch-size 128 --device 0 --cache ram --seed 50 --project YOLOv5_Rotate_scn_neck_head_test_d8_hyp_evo_beta2 --workers 20 --imgsz 320 --optimizer Adam

# d1 without beta2
# python train_rotate_scn.py --data stanford_dogs_new.yaml --epochs 500 --weights '' --cfg yolov5s_scn_neck_head_d1.yaml --hyp data/hyps/hyp.scratch-hyp-evolution.yaml --batch-size 128 --device 0 --cache ram --seed 50 --project YOLOv5_Rotate_scn_neck_head_test_d1_hyp_evo_beta2 --workers 20 --imgsz 320 --optimizer Adam

python train_rotate_scn.py --data stanford_dogs_new.yaml --epochs 1 --weights '' --cfg yolov5s_scn_neck_head_d1.yaml --hyp data/hyps/hyp.scratch-hyp-evolution.yaml --batch-size 32 --device 0 --cache ram --seed 50 --project YOLOv5_Rotate_scn_neck_head_test_d1_hyp_evo_beta2 --workers 20 --imgsz 320 --optimizer Adam
