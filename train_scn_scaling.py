...
# 
from utils.augmentations import ( # from the utils import useful transformations
    Albumentations,
    augment_hsv,
    ...
    letterbox,
    mixup,
    random_perspective, # this is what we should do 
)
...
#　start to make all training loop
    ...
    for epoch in range(start_epoch, epochs):  # epoch ------------------------------------------------------------------
        ...
        for i, (imgs, targets, paths, _) in pbar:  # batch -------------------------------------------------------------
            ...
            # Forward
            # change the factor here to make this part run with getting alpha
            # change the factor here to make this part run with getting alpha
            angle = random.uniform(0, 360) # uniformly set an angle from 0-2*pi
            img, targets = random_perspective(
                    img,
                    targets, 
                    degrees=hyp["degrees"],
