...
# new train mode 10.17 These two are working for the thesis
python train_rotate_scn.py --data stanford_dogs_new.yaml --epochs 500 --weights '' --cfg yolov5s_scn_neck_d1.yaml --hyp data/hyps/hyp.scratch-low-non-rotate_adam.yaml --batch-size 128 --device 0 --cache ram --seed 50 --project YOLOv5_Rotate_scn_neck_test_d1 --workers 20 --imgsz 320 --optimizer Adam
# 
python train_rotate_scn.py --data stanford_dogs_new.yaml --epochs 500 --weights '' --cfg yolov5s_scn_neck_d8.yaml --hyp data/hyps/hyp.scratch-low-non-rotate_adam.yaml --batch-size 128 --device 0 --cache ram --seed 50 --project YOLOv5_Rotate_scn_neck_test_d8 --workers 20 --imgsz 320 --optimizer Adam
