...
from utils.augmentations import ( # pre-defined data_argumentation
    ...
    mixup,
    random_perspective,
    fixed_perspective_batch,  # used to do transformations and other steps
)
...
def run( # 
    ...
    for batch_i, (im, targets, paths, shapes) in enumerate(pbar):
        callbacks.run("on_val_batch_start") # The other step is ?

        # start with trying with other steps
